...
$clauseWhere=" idUser in (Select id from $resTable where id!=$user->id and idle=0 ) AND refType='$filterObjectClass' AND isShared=1 ";
$orderByLayout = "sortOrder ASC";
$filterList=$flt->getSqlElementsFromCriteria(null, false,$clauseWhere,$orderByLayout);
