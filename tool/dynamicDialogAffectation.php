           ...
           <tr id="affectationToProfile" name="affectationToProfile"  >
             ...
             <td>
               ...
               <?php echo autoOpenFilteringSelect();?>
                ...
                class="input <?php echo ($objTeam=="Team" or $objTeam=="Organization" or $objTeam=="ResourceTeam" or $objTeam=="ResourceMaterial")?'':'required';?>"  value="<?php 
               ...
               <?php echo ($objTeam=="Team" or $objTeam=="Organization" or $objTeam=="ResourceTeam" or $objTeam=="ResourceMaterial") ?"required=false":"";?> <?php echo ($objTeam=="Team" or $objTeam=="Organization")?"readonly=readonly":"";?>>
