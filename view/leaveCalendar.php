                        ...
                        foreach($lvsEarned as $lve) {
                          ...
                          if (!in_array($lve->idLeaveType, $validLeaves))
                            ...
                            if($lvTypeOfEmpContractType->periodDuration){
                                echo '<td>'.$lvTypeOfEmpContractType->periodDuration.' '.i18n( ($lvTypeOfEmpContractType->periodDuration<=1 ? 'colMonth':'colMonths') ).'</td>';
                            }else{
                                echo '<td> - </td>';
                            }
                            // Period
                            ...
                            echo '<td>'.$theStartDate.'<br/>'.$theEndDate.'</td>';
                            ...
                            if($lve->quantity){
                                ...
                                $recorded=number_format($lve->quantity - $lve->leftQuantity, 1);
                                if($recorded==0)$sumLeave=0;
                                $taken=$sumLeave;
                                $left=number_format($lve->leftQuantity, 1);
                                echo '<td>'.htmlDisplayNumericWithoutTrailingZeros($quatity).'</td>';
                                echo '<td>'.htmlDisplayNumericWithoutTrailingZeros($recorded).'</td>';
                                echo '<td>'.htmlDisplayNumericWithoutTrailingZeros($taken).'</td>';
                                echo '<td>'.htmlDisplayNumericWithoutTrailingZeros($left).'</td>';
                            } else {
                                $recorded=" - ";
                                $taken=" - ";
                                ...
                                echo '<td> - </td>';
                                echo '<td id="summaryRecordedDays'.$lve->id.'">'.$recorded.'</td>';
                                echo '<td id="summaryTakenDays'.$lve->id.'">'.$taken.'</td>';
                            ...
                            if ($right['quantity']) {
                                ...
                                echo '<td>'.htmlDisplayNumericWithoutTrailingZeros($theQuantity).'</td>';
                            } else {
                                echo '<td> - </td>';                                
                            }
                            echo '</tr>';
