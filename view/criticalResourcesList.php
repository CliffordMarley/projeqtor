...
<div dojoType="dijit.layout.BorderContainer" id="criticalResourcesParamDiv" name="criticalResourcesParamDiv">
  <div dojoType="dijit.layout.ContentPane" region="top" id="criticalResourcesButtonDiv" class="listTitle" >
    ...
    <form dojoType="dijit.form.Form" name="criticalResourcesForm" id="criticalResourcesForm" action="" method="post" style="padding-bottom:20px;">
      <table width="100%" height="64px" class="listTitle">
        <tr height="32px">
            ...
            <table>
                ...
                <td style="padding-left:20px;">
                  ...
                  <strong><option value=" ">
                   ...
                   ?>
                                 ...
                                 <td>
                  <div style="position:absolute;right:20px;padding:5px 10px;top:32px;border:1px solid #cccccc;background:#ffffffE0;" >
                    <table>
              ...
              <tr>
                <td>
                  <div dojoType="dijit.form.DropDownButton" id="parameterCriticalResource" jsId="parameterCriticalResource" name="parameterCriticalResource" style="position:absolute;right:20px;padding:5px 10px;top:125px;"
                   showlabel="false" class="comboButton" iconClass="dijitButtonIcon dijitButtonIconExtraButtons" class="detailButton" title="<?php echo i18n('parameterCriticalResource');?>">
                     <div dojoType="dijit.TooltipDialog" class="white" id="dialogParameterCriticalResource" style="position: absolute; top: 50px; right: 40%">
                        <table>
...
?>
  <div style="position:relative;" dojoType="dijit.layout.ContentPane" region="center" id="criticalResourcesWorkDiv" name="criticalResourcesWorkDiv">
    <div style="height:220px;">
      <div style="margin-left:2%;width:47%; max-width:768px; display:inline-block;">
        ...
        <?php 
            Affectable::drawCriticalResourceList($scale, $firstDay, $lastDay, $proj, $maxResources);
        ?>
        </div>
      </div>
